(function extendCatalog() {
  ...
  function extraDemo(t) {
    const map = {
      ...
      "word-break": {html:extraScene("overflow-wrap: anywhere","word-break-demo",`<p>frontend-specimen-laboratory.example.com/a-very-long-address</p>`),controls:action("word-break","切换断行"),hint:"长网址不应撑出手机屏幕"},
      ...
      "text-decoration": {html:extraScene("text-decoration","decoration-demo",`<a href="#text-decoration">这是一条可以识别的正文链接</a>`),controls:action("decoration","切换样式"),hint:"链接不应只依赖颜色来识别"},
